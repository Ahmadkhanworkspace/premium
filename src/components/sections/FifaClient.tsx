    ...
    <div className="min-h-screen bg-obsidian">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 text-center">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-9xl font-bebas tracking-tighter leading-none mb-8"
          >
          ...
          <motion.p 
            ...
            className="text-white/60 text-lg md:text-2xl max-w-3xl mx-auto font-inter mb-12 leading-relaxed"
          >
            {t("subtitle")}
          </motion.p>
          ...
          >
            <Link 
              href="/pricing"
              className="px-8 py-4 md:px-10 md:py-5 bg-gold-primary text-obsidian font-bold text-lg rounded-full hover:scale-105 transition-transform flex items-center gap-3 group"
            >
              {t("cta")}
      ...
      <section className="py-16 md:py-24 border-y border-white/5 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bebas tracking-wide mb-6 md:mb-8">
                {t("qualityTitle")}
              </h2>
              <p className="text-white/50 text-base md:text-lg font-inter mb-10 md:mb-12">
                {t("qualityDesc")}
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold mb-1 text-sm md:text-base">Ultra Low Latency</h4>
                    <p className="text-xs md:text-sm text-white/40">Watch in real-time with zero lag.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gold-primary/10 flex items-center justify-center text-gold-primary flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold mb-1 text-sm md:text-base">Adaptive Bitrate</h4>
                    <p className="text-xs md:text-sm text-white/40">Crystal clear 4K on any connection.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 aspect-video bg-obsidian">
                 <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        <Tv size={48} className="md:size-16 text-gold-primary/20 mb-4 mx-auto" />
                        <span className="text-gold-primary/40 font-bebas tracking-widest text-xs md:text-base">LIVE STREAM PREVIEW</span>
                    </div>
                 </div>
                 <div className="absolute top-4 left-4 px-2 py-1 bg-red-600 rounded text-[8px] md:text-[10px] font-bold tracking-tighter uppercase animate-pulse">LIVE 4K</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16 relative z-10">
            <h2 className="text-4xl md:text-6xl font-bebas tracking-wide mb-4">
            Official 2026 <span className="gold-gradient">Match Schedule</span>
            </h2>
            <p className="text-white/40 text-base md:text-lg font-inter max-w-2xl mx-auto">
        ...
        <div className="glass rounded-[2rem] md:rounded-[3rem] p-4 md:p-10 border border-white/5 relative z-10">
          <div className="max-h-[800px] overflow-y-auto pr-2 md:pr-4 custom-scrollbar space-y-4">
            {Array.from({ length: 104 }).map((_, idx) => {
              ...
              return (
                <div key={matchNum} className="group relative bg-[#0A0A0C]/50 border border-white/5 rounded-xl md:rounded-2xl p-4 md:p-6 hover:border-gold-primary/30 transition-all duration-300 overflow-hidden hover:bg-white/[0.02]">
                  ...
                  <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
                    <div className="w-full md:w-1/3 text-center md:text-left">
                      <div className="inline-block px-3 py-1 bg-gold-primary/10 border border-gold-primary/20 text-gold-primary text-[9px] md:text-[10px] font-bold tracking-widest uppercase rounded-full mb-2 md:mb-3">
                        Match {matchNum} • {phase}
                      </div>
                      <div className="text-xs md:text-sm font-inter text-white/40">
                        {date} <br className="hidden md:block" /> {venue}
                      </div>
                    </div>

                    <div className="flex-1 flex items-center justify-center gap-4 md:gap-10 w-full py-2">
                      <div className="text-center flex-1">
                        <div className="font-bebas text-xl md:text-3xl tracking-wide uppercase group-hover:text-gold-primary transition-colors">{teamA}</div>
                      </div>
                      <div className="font-bebas text-xl md:text-3xl text-white/20">VS</div>
                      <div className="text-center flex-1">
                        <div className="font-bebas text-xl md:text-3xl tracking-wide uppercase group-hover:text-gold-primary transition-colors">{teamB}</div>
                      </div>
                    </div>

                    <div className="w-full md:w-1/4 flex justify-center md:justify-end">
                      <button className="w-full md:w-auto px-6 py-2.5 md:py-3 border border-white/10 rounded-full text-white/60 font-bold text-xs md:text-sm tracking-wide hover:bg-gold-primary hover:text-obsidian hover:border-gold-primary transition-all">
                        Set Reminder
                      </button>
                    </div>
                  </div>
